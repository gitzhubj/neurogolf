...
- 核心变换：去掉全灰(5)中线行，上下两半对应行(i与i+6)逐位OR合并，非零值优先。
...
Baseline 实际架构: **Slice-based multi-op** — Concat+Mul+Pad+Slice+Sum (10 nodes, 9 initializers, 1328 bytes)
...
baseline_ops: Concat+Mul+Pad+Slice+Sum
baseline_nodes: 10
baseline_size_bytes: 1328
```

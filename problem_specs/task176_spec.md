...
- 核心变换：之字路径填充：红(2)形成周期4之字路径，黄(4)填充相邻段间封闭区域。
...
Baseline 实际架构: **Conv + logic gates** — Conv+Mul+Pad+Slice+Sum (6 nodes, 9 initializers, 1420 bytes)

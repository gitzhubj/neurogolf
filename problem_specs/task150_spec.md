...
Baseline 实际架构: **Reduce + Where conditional** — Cast+Gather+Greater+Less+ReduceSum+Squeeze+Sub+Where (12 nodes, 5 initializers, 1320 bytes)

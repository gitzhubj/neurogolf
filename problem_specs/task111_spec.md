...
Baseline 实际架构: **Reduce + arithmetic** — Add+ArgMax+Gather+Pad+ReduceSum+Slice (10 nodes, 9 initializers, 1457 bytes)
...
baseline_ops: Add+ArgMax+Gather+Pad+ReduceSum+Slice
baseline_nodes: 10
baseline_size_bytes: 1457
```

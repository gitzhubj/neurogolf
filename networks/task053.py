"""Task 053 — 核心变换：整体下移一行。第一行清空为背景(0)，原行0→行1，原行1→行2，原行2移出。

架构: gather_spatial (unknown)
Baseline 参数: 30, 节点: 1
"""
...
spatial_idx_data = np.array([2, 0, 1, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29], dtype=np.int64)

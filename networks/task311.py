"""Task 311 — 核心变换：水平镜像扩展。输入 3 列 → 输出 6 列。
...
spatial_idx_data = np.array([0, 1, 2, 2, 1, 0, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3], dtype=np.int64)
...
def build():
    ...
    nodes.append(helper.make_node("Gather", ["input", "spatial_idx"], ["output"], axis=3))
